...
public class AndroidWebServiceEx extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        resister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                Intent intent=new Intent(AndroidWebServiceEx.this,RegisterUser.class);
    ...
    public String PostData(String[] valuse) {
        ...
        try
        {
            ...
            HttpPost httpPost=new HttpPost("http://192.168.43.142:8082/HttpPostServlet/servlet/Login");
